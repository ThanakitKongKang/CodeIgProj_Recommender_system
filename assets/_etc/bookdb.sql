...
(1, 'William John Teahan', 'Artificial Intelligence – Agent Behaviour', 'Artificial Intelligence', NULL, 4, 2),
(2, 'William John Teahan', 'Artificial Intelligence – Agents and Environments', 'Artificial Intelligence', NULL, 3, 2),
(3, 'William John Teahan', 'Artificial Intelligence_ Exercises I', 'Artificial Intelligence', NULL, 0.5, 1),
(4, 'William John Teahan', 'Artificial Intelligence_ Exercises II', 'Artificial Intelligence', NULL, 4, 1),
(5, 'David Haskins', 'C Programming in Linux', 'Programming', NULL, 5, 2),
(6, 'Poul Klausen', 'C# 1', 'Programming', 'Introduction to programming and the C# language', 3.5, 1),
(7, 'Kjell Backman', 'Structured Programming with C++', 'Programming', '', 1.5, 1),
(8, 'Poul Klausen', 'Introduction to Web Services with Java', 'Java Programming', NULL, 3.5, 1),
(9, 'Poul Klausen', 'Java 1_ Basic syntax and semantics', 'Java Programming', NULL, 2.5, 1),
(10, 'Poul Klausen', 'Java 2_ Programs with a graphical user interface', 'Java Programming', NULL, 3.5, 2),
(11, 'Poul Klausen', 'Java 3_ Object-oriented programming', 'Java Programming', NULL, 4, 1),
(12, 'Poul Klausen', 'Java 4_ Java’s type system and collection classes', 'Java Programming', NULL, 2.17, 3),
(13, 'Poul Klausen', 'Java 5_ Files and Java IO', 'Java Programming', NULL, 4, 1),
(14, 'Poul Klausen', 'Java 6_ JDBC and database applications', 'Java Programming', NULL, NULL, 0),
(15, 'Poul Klausen', 'Java 7_ About system development', 'Java Programming', NULL, 5, 1),
(16, 'Poul Klausen', 'Java 8_ Multithreaded programs', 'Java Programming', NULL, 4, 1),
...
(50, 'Leif Mejlbro', 'Examples of Applications of The Power Series', 'Calculus', NULL, NULL, 0),
(51, 'Leif Mejlbro', 'Examples of Differential Equations of Second', 'Calculus', NULL, NULL, 0),
