...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 14, 2019 at 08:24 AM
...
(16, 'Poul Klausen', 'Java 8_ Multithreaded programs', 'Java Programming', NULL, 2.625, 1),
...
(24, 'Poul Klausen', 'Java 16_ Mobile phones and Android', 'Java Programming', NULL, 3.625, 1),
...
(39, 'Leif Mejbro', 'Calculus of Residua', 'Calculus', NULL, 4.125, 1),
(40, 'Lars-Ake Lindahl', 'Convexity', 'Calculus', NULL, 3.375, 1),
(41, 'Mqondisi Bhebhe', 'Decision-Making using Financial Ratios', 'Calculus', NULL, 3.875, 1),
...
(45, 'Leif Mejbro', 'Examples of Applications of The Power Series', 'Calculus', NULL, 3.875, 1),
...
(58, 'Lars-Ake Lindahl', 'Linear and Convex Optimization', 'Calculus', NULL, 4.125, 1),
...
(87, 'Eric Ries', 'UX for Lean Startups_Faster, Smarter User Experience Research and Design', 'Human computer interaction', NULL, 3.625, 1),
...
(105, 'Dr.K.Raghava Rao', 'Introduction to Design Analysis of Algorithms - In Simple Way', 'Analysis of Algorithms', 'This book was very useful to easily understand the algorithms. This book is having enough examples in every algorithm. It was written for the sake of students to provide complete knowledge of Algorithms.', 4.125, 1),
(106, 'Sanjoy Dasgupta', 'Algorithms', 'Analysis of Algorithms', 'This text, extensively class-tested over a decade at UC Berkeley and UC San Diego, explains the fundamentals of algorithms in a storyline that makes the material enjoyable and easy to digest. Emphasis is placed on understanding the crisp mathematical idea behind each algorithm, in a manner that is intuitive and rigorous without being unduly formal.', 4.125, 1),
