                                ...
                                <li class="nav-item dropdown custom_dropleft">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="userDropdown" id="userDropdown_show">
                                        <?php if ($this->session->userdata('user')['username'] != "admin") { ?>
                                            <a class="dropdown-item <?php if (isset($yourcourse)) echo $yourcourse; ?>" href="<?= base_url() ?>course"><i class="fas fa-book-reader pr-2"></i>My course</a>
                                        ...
                                        <?php  } else { ?>
                                            ...
                                            <hr class="my-2">
                                        <?php } ?>
                                        <a class="dropdown-item" href="<?= base_url() ?>assets/manual/manual.pdf" target="_blank"><i class="fas fa-question-circle pr-2 color_secondary"></i>Help</a>
