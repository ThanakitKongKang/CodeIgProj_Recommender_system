            ...
            if (!$final_recommend_list) echo "recommended list is empty";
                ...
                <div class="hover_img">
                    ...
                    <div class="hover_img_content text-center">
                        ...
                        <div class="small mt-4 mb-2 badge badge-success">Match <?php if (isset($final_recommend_list[0]['match'])) echo number_format($final_recommend_list[0]['match'] * 100, 0);
                                                                                    else echo "0"; ?>%</div>
                                        ...
                                        <div class="hover_img_content_mid text-center">
                                            ...
                                            <div class="mt-5 text-center">
                                                ...
                                                <?php if ($top['count_rate'] != 0) { ?>
                                                    ...
                                                    <div class="small"><?= number_format($top['b_rate'], 1) ?>/5.0 rated by <?= $top['count_rate'] ?> user(s)</div>
                                                <?php } ?>
                                            </div>
                                        </div>
                                    </div>
